...
{
    [TestClass]
    public class Empirical_testing_Simple_method_for_searching_coeffs_polinoms_of_Gauss
    {
        [TestMethod]
        public void Gauss_polinomCreatorWithNormalValuesFixedK1()
        {
            ...
            int n = 17, k = 9;
            List<int> list = gauss_Polinom.A_simple_way_to_find_the_coefficients_of_a_Gauss_polynomial(n, k);
